...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initDynamicLinks() async {
    //onLink se ejecuta cuando el abre la app desde un dynamic link
  ...
  Future<void> _createDynamicLink(bool short) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      // Esta opción permite generar links aún más cortos de sólo 4 chars(en vez de 17)
  ...
  Future<void> _createDynamicLink2(bool short) async {
    var _random = new Random();
    ...
    if (short) {
      ...
      final ShortDynamicLink shortenedLink =
        ...
        Uri.parse(
            'https://conectemos.page.link/?link=https://qbo.cl/?partida_id=${_random.nextInt(100)}&apn=cl.chihau.conectemos&ofl=https://www.qbo.cl'),
      );
